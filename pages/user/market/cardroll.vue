<template>
	<view class="shop">
		<cu-custom bgColor="bg-gradual-blue" :isBack="true"><block slot="content">卡卷活动发布</block></cu-custom>
		<!-- <view class="biao" style="margin-top: 55px;"> -->
			...
			<view class="cu-form-group ">
				<view class="title"><span style="color: red;padding-right: 5px;">*</span> 活动名称：</view>
				<input placeholder="如'新春大促'" name="input" v-model="list.address"></input>
			</view>
			<view class="cu-form-group ">
				<view class="title"><span style="color: red;padding-right: 5px;">*</span> 优惠卷面额：</view>
				<input placeholder="最大设置999999.99" name="input" v-model="list.address"></input>元
			</view>
			<view class="cu-form-group ">
				<view class="title"><span style="color: red;padding-right: 5px;">*</span> 可用卷订单金额：</view>
				<input placeholder="必须大于优惠卷面额" name="input" v-model="list.address"></input>元
			</view>
			<view class="cu-form-group ">
				<view class="title"><span style="color: red;padding-right: 5px;">*</span> 卷发放时间：</view>
				...
				<input placeholder="请选择下列开始和结束时间" name="input" disabled="true" v-model="list.address"></input>
			</view>
			<view class="cu-form-group ">
				<input class="start"  @click="defaultTimeChange('0')" name="input" disabled="true" v-model="startTime"></input>--
				<input class="end"  @click="defaultTimeChange('1')" name="input" disabled="true" v-model="endTime"></input>
			</view>
			<view class="cu-form-group ">
				<view class="title"><span style="color: red;padding-right: 5px;">*</span> 卷发放总量：</view>
				<input placeholder="最大设置999999" name="input" v-model="list.address"></input>
			</view>
			<view class="cu-form-group ">
				<view class="title"><span style="color: red;padding-right: 5px;">*</span> 卷领限制：</view>
			...
			<view class="cu-form-group ">
				<view class="title"><span style="color: red;padding-right: 5px;">*</span> 卷使用日期：</view>
				<view class="time" >
			...
			<view class="cu-form-group ">
				<view class="title"><span style="color: red;padding-right: 5px;">*</span> 卷使用时段：</view>
				<view class="time" >
					<view class="biao_05_2"> 
						<view class="uni-list-cell-db">
