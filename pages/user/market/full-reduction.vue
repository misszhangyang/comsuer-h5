<template>
	<view class="shop">
		<cu-custom bgColor="bg-gradual-blue" :isBack="true"><block slot="content">满减活动发布</block></cu-custom>
		<!-- <view class="biao" style="margin-top: 55px;"> -->
			...
			<view class="cu-form-group ">
				...
				<input name="input" v-model="list.amout"></input>元减
				<input name="input" v-model="list.discount"></input>
				<view class="title"><span style="color: red;padding-right: 5px;">*</span>元</view>
			</view>
			<view class="cu-form-group ">
