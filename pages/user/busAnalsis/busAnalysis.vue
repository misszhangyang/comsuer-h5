<template>
	<view class="reseller">
		<cu-custom bgColor="bg-gradual-yellow" style="color: #FFFFFF;font-size: 18px;" :isBack="true"><block slot="content">经营分析</block></cu-custom>
		<view class="top">
			 <view class="uni-flex uni-column">
					 <view  style="width: 100%;height:45px;background: #29b105;">
					 </view> 
					<view style="width:100%;margin:0 auto;height:20%;background:#FFFFFF;">
						<view class="middle-bottom flex-sub  padding-sm margin-xs">
							<view  class="bottom-text1">今日收入(元)</view>
							<view class="bottom-text2">0.00</view>
					</view>
		     </view>
			
			<view class="icon">
				</view style="width:100%;margin:0 auto;height:350px;">
					231321
				</view>
					<!-- 排序板块 -->
...
<style lang="less">
	...
	.reseller {
		...
		.icon {
			...
			height: 300px;
			background: #fff;
            border-bottom: 1pd solid #0062CC;
